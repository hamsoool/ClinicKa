...
export default function StudentAnnouncements() {
  ...
  if (isError) {
    return (
      <div className="mx-auto w-full max-w-6xl rounded-2xl border border-outline-variant/30 bg-surface-container-lowest p-6 text-sm text-on-surface-variant">
  ...
  return (
    <div className="mx-auto w-full max-w-7xl space-y-3">
      <div>
        <h1 className="text-xl font-semibold text-on-surface sm:text-2xl">Announcements</h1>
      </div>

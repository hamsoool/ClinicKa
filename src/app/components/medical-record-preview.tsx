...
const MedicalRecordPreviewBase = forwardRef(function MedicalRecordPreviewBase(
  ...
  const renderCheckbox = (checked: boolean) => (
    <span
      className="pdf-print-exact relative inline-block h-[10px] w-[10px] shrink-0 print:shrink-0"
    ...
    <div ref={ref} className="pdf-print-exact flex flex-col gap-4 bg-white print:gap-0">
      {slotPages.map((slots, pageIndex) => (
        ...
        >
          ...
          {/* ── BLOCK 2: PERSONAL INFORMATION ── */}
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {/* ── NAME ROWS ── */}
            <div
              className="flex items-stretch print:flex print:flex-row print:items-stretch"
              style={{ display: 'flex', alignItems: 'stretch', marginTop: '0' }}
            >
              {/* Last Name */}
              <div className="w-[130px] min-w-[130px] shrink-0 print:min-w-[130px]" style={{ width: '130px', flexShrink: 0 }}>
                <div
                  className="flex h-[20px] items-baseline gap-1 print:flex print:flex-row print:items-baseline"
                  style={{ display: 'flex', alignItems: 'baseline', gap: '4px', height: '20px' }}
                >
                  <span style={S.fieldLabel}>Name:</span>
                  {renderLineField(record.lastName, 'flex-1', { flex: 1 })}
                </div>
                <div style={{ fontWeight: 'bold', fontSize: '10.5px', marginTop: '2px', paddingLeft: '55px' }}>
                  Last Name
                </div>
              </div>
              ...
              <div className="ml-[6px] min-w-[220px] flex-[2] print:min-w-[220px]" style={{ flex: 2, marginLeft: '6px' }}>
                <div className="flex h-[20px] items-baseline print:flex print:flex-row print:items-baseline" style={{ height: '20px', display: 'flex', alignItems: 'baseline' }}>
              ...
              <div className="ml-[8px] min-w-[250px] flex-[1.2] print:min-w-[250px]" style={{ flex: 1.2, marginLeft: '8px' }}>
                ...
                >
                  ...
                  <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', marginLeft: '4px' }}>
                    <span style={S.fieldLabel}>Sex: F</span>
            ...
            {/* ── BIRTHDAY ROW ── */}
            <div
              className="flex flex-nowrap items-center gap-[6px] print:flex print:flex-row print:flex-nowrap"
              style={{
                display: 'flex',
                alignItems: 'center',
                gap: '6px',
            ...
            >
              ...
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', marginLeft: '10px' }}>
                <span style={S.fieldLabel}>Civil Status: Single</span>
            ...
            {/* ── PRESENT ADDRESS ── */}
            <div
              className="flex flex-nowrap items-baseline gap-[6px] print:flex print:flex-row print:flex-nowrap"
              style={{
                display: 'flex',
                alignItems: 'baseline',
                gap: '6px',
          ...
          {/* ── BLOCK 3: MEDICAL DETAILS ── */}
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {/* ── MEDICAL HISTORY ── */}
            <div style={{ fontWeight: 'bold', margin: '4px 0 2px 0', fontSize: '10.5px', position: 'relative', top: '-3.5px' }}>
            ...
            {/* ── OPERATION ── */}
            <div
              className="flex items-center gap-4 print:flex print:flex-row print:items-center"
              style={{
                display: 'flex',
                alignItems: 'center',
                marginBottom: '4px',
            ...
            >
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
                <span style={S.fieldLabel}>• Have you had any operation in the past?&nbsp; YES</span>
            ...
            <div
              className="flex items-center gap-1 print:flex print:flex-row print:items-center"
              style={{
                display: 'flex',
                alignItems: 'center',
                marginBottom: '4px',
            ...
            {/* ── EMERGENCY CONTACT ── */}
            <div
              className="flex items-baseline gap-1 print:flex print:flex-row print:items-baseline"
              style={{
                display: 'flex',
                alignItems: 'baseline',
                marginBottom: '4px',
            ...
            {/* ── PRIVACY WAIVER ── */}
            <div
              style={{ fontSize: '9.5px', lineHeight: '1.7', margin: '4px 0' }}
            >
          ...
          {/* ── BLOCK 4: SIGNATURE ── */}
          <div style={{ display: 'flex', flexDirection: 'column', position: 'relative', top: '-7.5px' }}>
            {/* ── SIGNATURE ── */}
            <div
              style={{ textAlign: 'right', marginBottom: '0', fontSize: '10.5px' }}
            >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            ...
            <div className="w-full min-w-[764px] print:min-w-[764px]">
              <table className="w-full min-w-[764px] table-fixed border-collapse print:min-w-[764px]" style={S.table}>
                ...
                <thead>
                  <tr>
                    <th style={{ ...S.th, width: EXAM_FIRST_COLUMN_WIDTH, minWidth: EXAM_FIRST_COLUMN_WIDTH }}>
                      <span style={{ position: 'relative', top: '-4px', display: 'block' }}>Physical Examination</span>
                    </th>
                    {slots.map((slot) => (
                      <th
                        key={slot}
                      ...
                      >
                        <span style={{ position: 'relative', top: '-4px', display: 'block' }}>
                ...
                <tbody>
                  {EXAM_ROWS.map((row) => (
                    <tr key={row}>
                      <td style={{ ...S.td, fontWeight: 'bold' }}>
                        <span style={{ position: 'relative', top: '-4px', display: 'block' }}>{row}</span>
                      </td>
                      {slots.map((slot) => (
                  ...
                  <tr>
                    <td style={{ ...S.td, fontWeight: 'bold' }}>
                      <span style={{ position: 'relative', top: '-4px', display: 'block' }}>Examined by:</span>
                    </td>
                    {slots.map((slot) => (
                ...
                <tbody>
                  ...
                  <tr>
                    <td style={{ ...S.td, verticalAlign: 'top', fontWeight: 'bold' }}>
                      <span style={{ position: 'relative', top: '-5px', display: 'block' }}>OTHERS:</span>
                    </td>
                    {slots.map((slot) => (
                      <td key={slot} style={S.td}>
                        <span style={{ position: 'relative', top: '-5px', display: 'block' }}>
